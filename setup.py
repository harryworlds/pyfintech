...
# --- get version ---
with open("details/version.py") as f:
    line = f.read().strip()
...
with io.open(path.join(here, 'details/README.txt'), encoding='utf-8') as f:
    long_description = f.read()

setup(
  name='pyfintech',
  version=version,
  description='A comprehensive library for corporate finance & Technology in Python',
  long_description=long_description,
  author='Hemant Thapa',
  author_email='hemantthapa1998@gmail.com',
  url='https://github.com/harryworlds/pyfintech',
  license='MIT', 
